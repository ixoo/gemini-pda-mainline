# Experiment: agent routing and workflow pilot 02
...
Continue the event-driven workflow measurement after
[pilot 01](../2026-09-05-agent-routing-pilot/README.md) closed at ten accepted
offline items. Pilot 01 did not contain five comparable items in any review
group, so this successor inherits baseline decision `baseline-01` unchanged.
