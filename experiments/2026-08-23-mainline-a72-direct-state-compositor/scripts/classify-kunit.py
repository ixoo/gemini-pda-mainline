#!/usr/bin/env python3
"""Classify the exact closed A72 direct-state KUnit/QEMU proof."""
...
PROFILE = "a72-direct-state-kunit"
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    ktap_start = lines.index("KTAP version 1")
    ktap = lines[ktap_start:]
...
def main() -> None:
    ...
    print("experiment=2026-08-23-mainline-a72-direct-state-compositor")
    ...
    print("transaction_caller=false")
    print("cpu_on=false")
    print("cpu_off=false")
