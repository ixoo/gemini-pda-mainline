#!/usr/bin/env python3
"""Classify the hardware-free MT6797 watchdog-takeover KUnit suite."""
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    suite_summary = f"# {SUITE}: pass:5 fail:0 skip:0 total:5"
...
def main() -> None:
    ...
    print("experiment=2026-08-26-mainline-mtk-wdt-recovery-takeover")
    ...
    print("watchdog_takeover_symbols=present")
