#!/usr/bin/env python3
"""Mutation tests for the MT6797 watchdog-takeover KUnit classifier."""
...
SPEC = importlib.util.spec_from_file_location("watchdog_takeover_classifier",
                                              CLASSIFIER)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
RELEASE = "7.1.3-gemini-wdt-takeover-kunit"
