...
def apply_production(root: Path) -> None:
    ...
    replace_once(driver, "#define WDT_MODE_KEY\t\t0x22000000\n",
                 ...
                 "#define WDT_MODE_RECOVERY_DISABLE_MASK "
                 "(WDT_MODE_IRQ_EN | WDT_MODE_DUAL_EN)\n"
                 "#define WDT_MODE_RECOVERY_ENABLE_MASK "
                 "(WDT_MODE_EN | WDT_MODE_AUTO_START)\n"
                 "#define WDT_MODE_RECOVERY_MASK "
                 "(WDT_MODE_RECOVERY_DISABLE_MASK | "
                 "WDT_MODE_RECOVERY_ENABLE_MASK)\n"
