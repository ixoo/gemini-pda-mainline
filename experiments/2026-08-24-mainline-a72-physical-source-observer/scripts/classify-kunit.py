#!/usr/bin/env python3
"""Classify the exact hardware-free A72 physical-source KUnit suite."""
...
EXPECTED_CASES = (
    "mt6797_source_capture_order_test",
    "mt6797_source_capture_failures_test",
    "mt6797_source_lifecycle_test",
    "mt6797_source_lifecycle_failures_test",
)
...
def main() -> None:
    ...
    print("experiment=2026-08-24-mainline-a72-physical-source-observer")
    ...
    print("physical_source_symbols=present")
