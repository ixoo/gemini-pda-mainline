#!/usr/bin/env python3
"""Classify the exact hardware-free A34-v2 interlock KUnit proof."""
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    require(ktap.count("KTAP version 1") == 4,
...
def main() -> None:
    ...
    print("experiment=2026-08-23-mainline-a72-a34-v2-interlock")
