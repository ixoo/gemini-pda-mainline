...
EXPERIMENT = 'mt6797-consys-handoff-snapshot'
RECEIPT_NAME = 'mt6797-consys-handoff-deployment-1'
MANIFEST_SHA = '4555a998aafad83fa64356877593b63b50f085e41a0e70a324e66f6031201789'
PINS = {
...
def validate(candidate, previous):
    ...
    require(expected['kernel_release'] == '7.1.3-gemini-consys-handoff-snapshot' and
