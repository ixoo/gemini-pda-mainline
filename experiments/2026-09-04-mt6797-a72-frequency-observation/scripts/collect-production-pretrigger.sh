...
readonly VALIDATOR_SHA256=ce402b717874020dc0e740d0a4aa70047d9cbf4347bb2da091926ae0d7949462
readonly COMMAND_MARKER=__GEMINI_A72_FREQUENCY_PRETRIGGER_SCRIPT__
readonly EXPECTED_OUTPUT=artifacts/runtime-captures/a72-frequency-thermal-attempt-1
...
[[ "$(basename -- "$output")" == a72-frequency-thermal-attempt-1 ]] || die 'output identity changed'
