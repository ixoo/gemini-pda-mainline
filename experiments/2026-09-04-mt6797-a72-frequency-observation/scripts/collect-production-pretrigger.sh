...
readonly EXPECTED_OUTPUT=artifacts/runtime-captures/a72-frequency-thermal-zero-divider-attempt-1
...
[[ "$(basename -- "$output")" == a72-frequency-thermal-zero-divider-attempt-1 ]] || die 'output identity changed'
