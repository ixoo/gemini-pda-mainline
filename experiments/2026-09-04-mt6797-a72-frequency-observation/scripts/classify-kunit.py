#!/usr/bin/env python3
"""Classify the focused MT6797 protected clock-state KUnit runtime."""
...
PROFILE = "mt6797-dvfsp-clock-state-kunit"
SUITE = "mt6797-dvfsp-clock-state"
EXPECTED_CASES = (
    "mt6797_clock_state_stable_strobes_test",
    "mt6797_clock_state_big_fields_test",
