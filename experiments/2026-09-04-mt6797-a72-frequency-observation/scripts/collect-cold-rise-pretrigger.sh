...
readonly EXPECTED_OUTPUT=artifacts/runtime-captures/a72-frequency-thermal-cold-rise-1
...
[[ "$(basename -- "$output")" == a72-frequency-thermal-cold-rise-1 ]] || die 'output identity changed'
...
python3 "$script_dir/compare-cold-rise.py" gate --capture "$output"
