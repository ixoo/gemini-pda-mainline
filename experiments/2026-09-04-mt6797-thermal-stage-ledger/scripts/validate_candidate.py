#!/usr/bin/env python3
"""Independently validate the exact thermal-stage-ledger boot candidate."""
...
CANDIDATE_DIR = "candidate-mt6797-thermal-stage-ledger-c015bc24"
...
CANDIDATE_INITRAMFS = "gemini-mt6797-thermal-stage-ledger-initramfs.img"
CANDIDATE_BOOT = "gemini-mt6797-thermal-stage-ledger.boot.img"
PADDED_BOOT = "boot2-padded.img"
BOOT2_SIZE = 16 * 1024 * 1024
CANDIDATE_RAW_SIZE = 7557120
CANDIDATE_RAW_SHA256 = "c015bc244916ed9e62ee03d05a58d5e28141f123a19771ffaa3c19278b03cd0e"
CANDIDATE_PADDED_SHA256 = "dcb2b4e8dd8353177f86a81b3019b42becb286baf2ab0b73aafaf49901780486"
...
def validate(
    ...
    for key, expected in (
        ("experiment", "2026-09-04-mt6797-thermal-stage-ledger"),
        ...
        ("thermal_ledger_physical_base", "0x44415000"),
        ("thermal_ledger_size", "4096"),
        ("thermal_ledger_attempt_id", "0x54484d4c00000001"),
        ("thermal_ledger_predecessor", "empty-only"),
        ("thermal_ledger_max_commits", "96"),
        ("device_action", "none"),
        ("hardware_write", "none"),
    ):
...
def main() -> int:
    ...
    print("validation=mt6797-thermal-stage-ledger-candidate")
    ...
    print("thermal_ledger_record=5")
    print("thermal_ledger_physical_base=0x44415000")
    print("thermal_ledger_attempt_id=0x54484d4c00000001")
