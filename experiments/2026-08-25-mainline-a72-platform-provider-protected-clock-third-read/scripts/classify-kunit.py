#!/usr/bin/env python3
"""Classify the hardware-free platform/provider/protected-clock composition KUnit suite."""
...
PROFILE = "a72-platform-provider-clock-kunit"
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    suite_summary = f"# {SUITE}: pass:8 fail:0 skip:0 total:8"
...
def main() -> None:
    ...
    print("experiment=2026-08-25-mainline-a72-platform-provider-protected-clock-third-read")
    ...
    print("platform_provider_clock_symbols=present")
