...
# Bounded read-only live probe for the exact three-reader candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=1f7bd9600e11846af352abbec660db816c378094664f81d861b9fbd1f1f16aa2
...
$BB printf 'snapshot_failure_lines='; $BB dmesg 2>/dev/null | $BB grep -aFc 'platform/provider/clock capture failed' || true
