...
def main() -> None:
    ...
    mutations = (
        ...
        ("runtime-attempt-clock", contract, '"protected_clock_calls": 0', '"protected_clock_calls": 1'),
        ("runtime-attempt-retry", contract, '"unchanged_retry_allowed": false', '"unchanged_retry_allowed": true'),
