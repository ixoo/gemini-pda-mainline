#!/usr/bin/env python3
"""Classify the exact DA921x same-value-write KUnit suite."""
...
def main() -> None:
    ...
    print("experiment=2026-08-19-mainline-da921x-same-value-write-implementation")
