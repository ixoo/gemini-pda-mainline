...
# Bounded read-only live probe for the exact Stage-27 minimum-contract candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=662e86846e783cf29b13c388f9e88217fe7bd32933eef4f32df86e44def0b16b
