...
# Stream one bounded protected-readback observation through the initramfs
# netcat shell. This performs no mount, storage, driver, CPU, or power action.
set -eu
export LC_ALL=C

readonly INSTALLED_FULL_SHA256=30ec9c56d6be78635f0ccf3ea626727763d71590c23778774c5c6366e4a5e75a
