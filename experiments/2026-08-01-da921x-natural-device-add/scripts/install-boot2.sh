...
perl -0pe '
	...
	s#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#3665c0ec7a1d5fde6c5c7bdcbf90b13d73a35c150f2e39b9bfe1f660d8410069#g;
	s#__KEEP_OLD_CANDIDATE__#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#g;
	s#__NEW_CANDIDATE__#4855ad0f92e9f623b6e4f1c3ae08ac413895e9118c4a18a395546b66c4141472#g;
	s#de71c72f6dab69de7d3a2dee6fe7e98ca16c8e09d4d2811e64ef568eff40a53b#c9944e6e013e06e040f8f0b24f0c935824781479e5a1870dd339603b32f5138d#g;
	s#candidate-Gate3-da921x-untag-2a6dcc2a#candidate-Gate3-da921x-devadd-f94ffe35#g;
	s#DA921x untagged dispatch#DA921x natural device add#g;
	s#2026-08-01-da921x-uevent-untagged-dispatch#2026-08-01-da921x-natural-device-add#g;
	s#gemini-da921x-untag#gemini-da921x-devadd#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=3665c0ec7a1d5fde6c5c7bdcbf90b13d73a35c150f2e39b9bfe1f660d8410069' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=4855ad0f92e9f623b6e4f1c3ae08ac413895e9118c4a18a395546b66c4141472' \
