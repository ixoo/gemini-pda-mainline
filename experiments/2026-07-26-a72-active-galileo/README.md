...
The first assembled Galileo image was caught in pre-boot review with
...
and container validation passed for the corrected image. Runtime evidence will
be recorded in \`results/\` after the manual boot.
