...
# Read-only live frame for the exact serviceability-first CPU8 candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox
...
$BB printf '%s\n' installed_full_sha256=4e0f86885a16df2f8b0c1efb4dd2e67394938bad1ef720adabf70ff4635ec0ef
