#!/usr/bin/env python3
"""Classify the exact hardware-free live admission-trigger KUnit proof."""
...
PROFILE = "a72-admission-live-trigger-kunit"
...
def main() -> None:
    ...
    print("experiment=2026-08-28-mainline-a72-admission-live-trigger")
