#!/usr/bin/env python3
"""Validate the durable live frame before the one-shot CPU8 trigger."""
...
CANDIDATE = "4e0f86885a16df2f8b0c1efb4dd2e67394938bad1ef720adabf70ff4635ec0ef"
RELEASE = "7.1.3-gemini-a72-admission-live"
...
def main() -> int:
    ...
    try:
        ...
        reason = "exact-live-identity-and-armed-contract"
