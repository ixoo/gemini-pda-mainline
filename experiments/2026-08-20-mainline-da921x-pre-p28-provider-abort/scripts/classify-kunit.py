#!/usr/bin/env python3
"""Classify the exact pre-P28 DA921x membership-abort KUnit suite."""
...
PROFILE = "da921x-pre-p28-provider-abort-kunit"
...
def main() -> None:
    ...
    print("experiment=2026-08-20-mainline-da921x-pre-p28-provider-abort")
