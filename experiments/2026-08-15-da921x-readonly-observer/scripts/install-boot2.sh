...
# Source-pin and mechanically derive the current exact guarded boot2 installer.
# The inherited policy resolves live GPT boot2, records but does not back up the
# predecessor, verifies a full readback, and powers off after success.
set -euo pipefail
export LC_ALL=C
umask 077
...
replacements = (
    ("# Install the exact validated provenance-observer container to inactive boot2.",
     "# Install the exact validated DA921x read-only observer container to inactive boot2.", 1),
    ("readonly CANDIDATE_SHA256=ea603c1b1a64d4f1aa9cac3e53957a3e858a7ce04127f1aef36d4b0e8173cb02",
     "readonly CANDIDATE_SHA256=7a3ce120de99d7c5ad26dce618f81d50bfeb1ca95b5f2a0bdb9fbf4acba1f564", 1),
    ("readonly ARTIFACT_MANIFEST_SHA256=ad92d496dfb4fd183c35e6e0f32ce626b2045528657fb2567d8561dd02540f1a",
     "readonly ARTIFACT_MANIFEST_SHA256=136469317f099c2fea7d3c22cabde6cfb6d2c80fb692d9ea7066b43b7cafe0ed", 1),
    ("readonly ARTIFACT_NAME=gemian-runtime-provenance-observer-rndis-1d303dda10b4",
     "readonly ARTIFACT_NAME=candidate-da921x-readonly-observer-1a55a25b", 1),
    ("provenance-observer-deployment-", "da921x-readonly-observer-deployment-", 3),
    (r"\.gemini-provenance-observer\.", r"\.gemini-da921x-readonly-observer\.", 2),
    ("/home/gemini/.gemini-provenance-observer.XXXXXXXX",
     "/home/gemini/.gemini-da921x-readonly-observer.XXXXXXXX", 1),
    ("experiment=2026-08-14-mt6797-runtime-provenance-observer",
     "experiment=2026-08-15-da921x-readonly-observer", 1),
)
