#!/usr/bin/env python3
"""Classify the exact positive DA921x provider KUnit suite."""
...
PROFILE = "da921x-positive-provider-kunit"
...
EXPECTED_CASES = (
    ...
    "da9213_provider_admission_one_shot",
    "da9213_provider_acquire_failures",
    "da9213_provider_acquire_mismatches",
    "da9213_provider_release_failures",
...
def main() -> None:
    ...
    print("experiment=2026-08-20-mainline-da921x-positive-provider-transaction")
