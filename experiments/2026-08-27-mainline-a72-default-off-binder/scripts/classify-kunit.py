#!/usr/bin/env python3
"""Classify the exact hardware-free default-off binder KUnit proof."""
...
EXPECTED_RELEASE = "7.1.3-gemini-a72-binder-kunit"
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    require(plans == ["1..3", "1..30", "1..12", "1..5"],
...
def main() -> None:
    ...
    print("experiment=2026-08-27-mainline-a72-default-off-binder")
    ...
    print("focused_contract_tests=21")
    print("regression_tests=26")
    print("failed=0")
    print("skipped=0")
    ...
    print("qemu_exit=124")
    print("result=pass")
    print("binder_dt_node=absent-qemu-virt")
    print("production_callers=0")
    print("physical_backends_executed=0")
