...
# Source-pin the guarded serviceability installer and retarget only the exact
# current predecessor, diagnostic candidate, artifact manifest, and evidence.
set -euo pipefail
export LC_ALL=C
umask 077
...
derived=$(mktemp "$script_dir/.derived-install-a72-ready-plan-diagnostic.XXXXXXXX")
...
replacements = (
    ('("8acf9227e6539e5011ab59a27e1320bf970c19cbbf5a5325fe3304f0e04dddb7",\n     "f694ddb95649db38ad72d08dcb2f81688608dca44782f08cfe4412e06b26204a", 1)',
     '("8acf9227e6539e5011ab59a27e1320bf970c19cbbf5a5325fe3304f0e04dddb7",\n     "7ac6f42938365d8bb1de49803a46287186e9a25347039975c48c386d0c1d6272", 1)', 1),
    ...
    ("candidate-a72-provenance-serviceability-1921c30e", "candidate-a72-ready-plan-predicate-diagnostic-08eec751", 1),
    ('("a72-admission-trace", "a72-provenance-serviceability", 5)', '("a72-admission-trace", "a72-ready-plan-predicate-diagnostic", 5)', 1),
    ("2026-08-30-mainline-a72-provenance-serviceability-composition", "2026-08-30-mainline-a72-ready-plan-predicate-diagnostic", 1),
    (".derived-install-a72-provenance-serviceability-inner.XXXXXXXX", ".derived-install-a72-ready-plan-diagnostic-inner.XXXXXXXX", 1),
)
for old, new, count in replacements:
    actual = text.count(old)
    if actual != count:
        raise SystemExit(
            f"unsafe predicate-diagnostic installer derivation: expected {count}, found {actual}: {old}"
        )
