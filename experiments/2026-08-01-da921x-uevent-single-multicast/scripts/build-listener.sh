...
# Build the exact static ARM64 single-multicast listener in the managed VM.
set -euo pipefail
export LC_ALL=C
umask 077

readonly SOURCE_SHA256=3c447641f17c0245ed6ed112f936e8e195feb84e6f6e60e8b2a4d9634c6a7bd8
...
source_file="$(cd -- "$script_dir/../listener" && pwd -P)/single-multicast-listener.c"
