...
perl -0pe '
	...
	s#bf4b379696cf2a93806d969ffaa90d8652ab092f8643e0539d694ca7971f77e0#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#g;
	s#2dd4908ba4f65785a536b079f08c87fe096c6ed490ddc3294743c5b0d515576a#e1327619295ab7d739ebd76dbf31ac91691ad91ca086acb34728dbf69a1e54e5#g;
	s#__KEEP_2DD__#2dd4908ba4f65785a536b079f08c87fe096c6ed490ddc3294743c5b0d515576a#g;
	s#ce5f05bdea2d74a9e3d9d07764749dabea93a19ffa58c1aad4990aa9d4c3af0c#d1d8fff40a863c1427c24126dc2eef1a3fcdd75965b58266a61d3d5d8c9aa67d#g;
	s#candidate-Gate3-da921x-nodeliv-4c9a8600#candidate-Gate3-da921x-mcast1-1183d5cb#g;
	s#DA921x no-listener delivery#DA921x single multicast#g;
	s#2026-07-31-da921x-uevent-no-listener-delivery#2026-08-01-da921x-uevent-single-multicast#g;
	s#gemini-da921x-nodeliv#gemini-da921x-mcast1#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=e1327619295ab7d739ebd76dbf31ac91691ad91ca086acb34728dbf69a1e54e5' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274' \
