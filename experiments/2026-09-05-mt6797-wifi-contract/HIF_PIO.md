...
The coordinator reviewed the finite primitive, caller contract and fixture, then
independently ran the fixture with strict C11 warnings, AddressSanitizer and
UndefinedBehaviorSanitizer. Exact setup/data order, endian conversion, padding,
capacity refusal and immediate stop on callback errors passed. Temporary host
executables were removed. This accepts the original helper for integration;
there is still no real MMIO adapter, kernel compilation or hardware claim.
