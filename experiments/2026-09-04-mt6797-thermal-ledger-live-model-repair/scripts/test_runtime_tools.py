#!/usr/bin/env python3
"""Offline positive and rejection tests for thermal-ledger repair runtime tools."""
...
def load_classifier():
    spec = importlib.util.spec_from_file_location("thermal_ledger_live_model_classifier", CLASSIFIER)
...
def frame() -> str:
    values = {
        ...
        "thermal_nvmem_cell_names": "calibration-data", "auxadc_dt_status": "disabled",
        ...
        "nvmem_provider_count": "1", "nvmem_provider_name": "mt6797-atag-calibration0",
        ...
        "mmc_error_count": "0", "thermal_error_count": "1",
    ...
    lines = ["__GEMINI_THERMAL_LEDGER_LIVE_MODEL_REPAIR_BEGIN__"]
    lines.extend(f"{key}={value}" for key, value in values.items())
    lines.extend((
        "dmesg_excerpt_begin",
        "log: [    1.938521] probe of 1100b000.thermal returned -517 after 24 usecs",
        "log: [    2.136460] probe of 1100b000.thermal returned 0 after 138 usecs",
        "dmesg_excerpt_end",
    ))
    lines.append("__GEMINI_THERMAL_LEDGER_LIVE_MODEL_REPAIR_END__")
    return "\n".join(lines) + "\n"
...
def main() -> int:
    ...
    mutations = (
        ("live-dt", "dt_model=MT6797X", "dt_model=Planet Computers Gemini PDA (thermal serviceability)"),
        ...
        ("missing-defer", "log: [    1.938521] probe of 1100b000.thermal returned -517 after 24 usecs\n", ""),
        ("missing-success", "log: [    2.136460] probe of 1100b000.thermal returned 0 after 138 usecs\n", ""),
        ("wrong-order", "log: [    1.938521] probe of 1100b000.thermal returned -517 after 24 usecs\nlog: [    2.136460] probe of 1100b000.thermal returned 0 after 138 usecs", "log: [    2.136460] probe of 1100b000.thermal returned 0 after 138 usecs\nlog: [    1.938521] probe of 1100b000.thermal returned -517 after 24 usecs"),
        ("enodev", "log: [    2.136460] probe of 1100b000.thermal returned 0 after 138 usecs", "log: [    2.136460] probe of 1100b000.thermal returned 19 after 138 usecs"),
