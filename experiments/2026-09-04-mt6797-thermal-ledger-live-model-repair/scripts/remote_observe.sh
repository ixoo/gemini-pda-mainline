...
# One bounded read-only frame for the thermal-ledger live-model repair.
set -u
export LC_ALL=C
...
$BB printf '%s\n' __GEMINI_THERMAL_LEDGER_LIVE_MODEL_REPAIR_BEGIN__
...
$BB printf '%s\n' dmesg_excerpt_end
$BB printf '%s\n' __GEMINI_THERMAL_LEDGER_LIVE_MODEL_REPAIR_END__
