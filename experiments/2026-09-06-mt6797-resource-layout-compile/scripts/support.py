...
"""Shared bounded helpers for the offline resource-layout proposal."""
...
def git_environment():
    ...
    env.update(GIT_CONFIG_NOSYSTEM="1", GIT_CONFIG_GLOBAL=os.devnull,
               GIT_AUTHOR_NAME="MT6797 resource-layout experiment",
               GIT_AUTHOR_EMAIL="nobody@example.invalid",
               GIT_COMMITTER_NAME="MT6797 resource-layout experiment",
...
def scratch(kind):
    ...
    managed = artifacts / "resource-layout-compile"
    ...
    marker = "mt6797-resource-layout-compile-" + kind + "-v1\n"
