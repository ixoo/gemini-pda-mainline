...
# Read one exact serviceability result and both checkpoint markers over the
# initramfs netcat shell. This performs no partition, driver, CPU, regulator,
# retained-memory, or power action.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=43e7f44eeef694ef876f7686ae03e2a779a118141e7f9efa060ccc1182c8eac3
...
$BB printf '%s\n' __MANUAL_CHECKPOINT_STAGE_RUNTIME_BEGIN__
...
$BB printf '%s\n' reboot_request=none
$BB printf '%s\n' __MANUAL_CHECKPOINT_STAGE_RUNTIME_END__
