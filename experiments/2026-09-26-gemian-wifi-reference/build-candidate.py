...
PACKAGE_INVENTORY = '7822d68966364b16e943f76d7e56f9ffaa3a5ebfa978bec09d366d466d480205'
...
def main():
    ...
    assert digest(regular(bundle / 'SHA256SUMS')) == PACKAGE_INVENTORY
    ...
    assembler.KERNEL_FIELD_SHA256 = KERNEL
