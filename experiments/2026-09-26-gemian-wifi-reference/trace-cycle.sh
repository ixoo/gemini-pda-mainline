...
# One bounded ConnMan Wi-Fi off/on cycle under a narrow function trace.
set -euo pipefail
export LC_ALL=C
umask 077
...
readonly output=/var/tmp/gemini-wifi-reference-cycle-1
readonly functions=(
...
for attempt in 1 2; do
  ...
  timeout 15 connmanctl enable wifi || true
  for _ in {1..60}; do
