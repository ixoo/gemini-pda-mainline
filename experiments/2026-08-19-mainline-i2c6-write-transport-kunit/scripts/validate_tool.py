...
def validate_fragments(header: str, helpers: str, test: str, tool: str,
    ...
    require_tokens(classifier, (
        ...
        'manifest_checksum(sums, "./Image")',
        'manifest_checksum(sums, "./kernel.config")',
        "qemu_exit == 124",
        'ktap.count("1..12") == 1',
        ...
        'line.startswith(PANIC_PREFIX)',
        'line.startswith(PANIC_END_PREFIX)',
...
def test_mutations(header: str, helpers: str, test: str, tool: str,
    ...
    mutations = [
        ...
        ("classifier-unpackaged-image-hash", "classifier",
         'manifest_checksum(sums, "./Image")',
         'build["image_sha256"]'),
        ("classifier-panic-end-reordered", "classifier",
         "end_panic_indices[0] > panic_indices[0]",
         "end_panic_indices[0] >= panic_indices[0]"),
