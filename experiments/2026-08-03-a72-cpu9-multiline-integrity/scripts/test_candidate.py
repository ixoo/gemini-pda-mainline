#!/usr/bin/env python3
"""Independently validate the multiline-integrity Android-v0 candidate."""
...
EXPECTED = {
    "assembler_sha256": "a7e14b94947aca21038668463b307bbcf59304d55e329e6d7278b4ae2778ea1d",
    "parent_assembler_sha256": "2121b03995070321e49293d7e895433dab7a530de095b760d359910e5598252b",
    "builder_sha256": "c4dd5ac0d4b098e113fe60fed949db3033b369f9899dab7e0dcf177275abae8f",
    ...
    "raw_sha256": "4e3c1b1095ee87e0af3c45595ea83d859d53188a53aba10672202bf45938986a",
    "padded_sha256": "5227729e34ca42cf606f43008ec753fce15147693ce7a670818db58c5903fa48",
}
RAW_NAME = "gemian-a72-cpu9-multiline-integrity.boot.img"
...
def validate_candidate(candidate: Path) -> None:
    ...
    for token in (
        "experiment=2026-08-03-a72-cpu9-multiline-integrity",
        "device_access=none",
...
def main() -> int:
    ...
    print("validation=cpu9-multiline-integrity-candidate")
