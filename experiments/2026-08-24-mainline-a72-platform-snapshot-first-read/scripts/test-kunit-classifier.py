#!/usr/bin/env python3
"""Mutation tests for the closed A72 platform-snapshot QEMU classifier."""
...
SPEC = importlib.util.spec_from_file_location("platform_snapshot_classifier",
                                              CLASSIFIER)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
RELEASE = "7.1.3-gemini-a72-platform-kunit"
...
1..4
{cases}
# {MODULE.SUITE}: pass:4 fail:0 skip:0 total:4
...
def main() -> None:
    ...
    mutations = (
        ...
        raw.replace("pass:4 fail:0", "pass:3 fail:1", 1),
        raw.replace("1..4", "1..5", 1),
