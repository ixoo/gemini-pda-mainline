...
# dual-modalias read-only-state candidate.
set -euo pipefail
export LC_ALL=C
umask 077
...
perl -0pe '
	...
	s#ddb7fadf7cd41f7ef805e2120f299b8034b7fc5ccedea2b6da7fb9976794e072#5c3788905c6c3270d7416997c922f0774802fafb5086e10ff5f247ca0a26a1b3#g;
	s#79c3bcb9afde686659be552cfb906f142f392b72c662db2dc9f623b52b3f3141#ddb7fadf7cd41f7ef805e2120f299b8034b7fc5ccedea2b6da7fb9976794e072#g;
	s#81cdca19d56faba451804d358d631c9fe3b50624522768d9bb19fa0e0b1da648#6d5a81d43509fe88d23e3ac2abf3479f044281b3f7ba02240e6683e9b8ea4dba#g;
	s#candidate-Gate3-da921x-dualpre-8be48f43#candidate-Gate3-da921x-dualstate-53376218#g;
	s#DA921x dual-modalias pre-dispatch-suppression#DA921x dual-modalias read-only-state#g;
	s#2026-07-31-da921x-dual-modalias-pre-dispatch-suppression#2026-07-31-da921x-dual-modalias-state#g;
	s#gemini-da921x-dualpre#gemini-da921x-dstate#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=ddb7fadf7cd41f7ef805e2120f299b8034b7fc5ccedea2b6da7fb9976794e072' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=5c3788905c6c3270d7416997c922f0774802fafb5086e10ff5f247ca0a26a1b3' \
