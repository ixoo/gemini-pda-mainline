#!/usr/bin/env python3
"""Device-inert tests for Candidate AO's private live-FDT allowlist."""
...
SPEC = importlib.util.spec_from_file_location("candidate_ao_live_fdt_delta", SOURCE)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load Candidate AO live-FDT validator")
...
class SourcePinTests(unittest.TestCase):
    def test_common_delta_inventory_and_source_pins(self) -> None:
        ...
        self.assertEqual(VALIDATOR.EXPECTED_LIVE_FDT_SIZE, 52567)
