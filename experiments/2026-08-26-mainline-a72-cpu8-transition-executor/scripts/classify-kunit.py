#!/usr/bin/env python3
"""Classify the hardware-free CPU8 transition-executor KUnit suite."""
...
PROFILE = "a72-transition-executor-kunit"
SUITE = "mt6797-a72-transition-executor"
...
def main() -> None:
    ...
    print("experiment=2026-08-26-mainline-a72-cpu8-transition-executor")
    ...
    print(f"raw_log_sha256={raw_log_sha256}")
    print("transition_executor_symbols=present")
    print("physical_writer_symbols=absent")
