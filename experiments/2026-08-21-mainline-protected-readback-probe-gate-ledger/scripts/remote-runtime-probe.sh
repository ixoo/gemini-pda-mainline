...
# Stream one bounded probe/gate-ledger protected-readback observation through
# the initramfs netcat shell. This performs no storage, driver, CPU, or power action.
set -eu
export LC_ALL=C

readonly INSTALLED_FULL_SHA256=6cb729efacea914b993221f0f85a1ab7e67eb6bca915802a8236bb31edab2e62
