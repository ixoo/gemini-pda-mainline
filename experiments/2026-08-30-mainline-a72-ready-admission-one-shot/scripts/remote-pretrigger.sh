...
# Read-only live frame for the exact trace-softfail CPU8 candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox
...
$BB printf '%s\n' installed_full_sha256=8acf9227e6539e5011ab59a27e1320bf970c19cbbf5a5325fe3304f0e04dddb7
