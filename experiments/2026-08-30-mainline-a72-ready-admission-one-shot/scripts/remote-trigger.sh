...
ARMED='GEMINI_A72_ADMISSION_LIVE_V1 state=armed trigger_consumed=0 trigger_executions=0 operation_ret=-115 core_consumed=0 entry_trace_ret=0 terminal_trace_ret=0 cpu_requests=0 cpu9_requests=0 cpu_off_requests=0 retries=0'
