...
# Stream one bounded, read-only module-policy control record through the
# initramfs netcat shell. This performs no mount, storage, driver, CPU, or power
# action.
set -eu
export LC_ALL=C

readonly INSTALLED_FULL_SHA256=044461e57d207f5ddd6e68cc463ea3ee1dd65260c27afe5fd00730137d13a2ff
...
printf '%s\n' '__DA921X_MODULE_POLICY_CONTROL_RUNTIME_BEGIN__'
...
printf '%s\n' '__DA921X_MODULE_POLICY_CONTROL_DMESG_BEGIN__'
printf '%s\n' "$provider_lines"
printf '%s\n' '__DA921X_MODULE_POLICY_CONTROL_DMESG_END__'
...
printf '%s\n' 'reboot_request=none'
printf '%s\n' '__DA921X_MODULE_POLICY_CONTROL_RUNTIME_END__'
