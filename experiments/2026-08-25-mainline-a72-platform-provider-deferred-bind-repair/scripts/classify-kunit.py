#!/usr/bin/env python3
"""Classify the hardware-free provider-readiness KUnit suite."""
...
EXPECTED_CASES = (
    "mt6797_platform_provider_not_ready_test",
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    suite_summary = f"# {SUITE}: pass:7 fail:0 skip:0 total:7"
...
def main() -> None:
    ...
    print("provider_readiness_symbols=present")
