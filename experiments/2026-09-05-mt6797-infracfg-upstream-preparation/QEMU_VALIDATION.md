...
contains the direct guest if the coordinator is abruptly killed. Uncatchable
SIGKILL before the final atomic replacement leaves the initial incomplete
receipt authoritative; after replacement, the final receipt may already exist
even if directory fsync has not returned. The
