...
perl -0pe '
	...
	s#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#1b2b6c29a8c6891cc91c732472a3c8b9d4f8fce2cc935a18311f0f4d0da5035b#g;
	s#__KEEP_OLD_CANDIDATE__#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#g;
	s#__NEW_CANDIDATE__#3665c0ec7a1d5fde6c5c7bdcbf90b13d73a35c150f2e39b9bfe1f660d8410069#g;
	s#de71c72f6dab69de7d3a2dee6fe7e98ca16c8e09d4d2811e64ef568eff40a53b#22971b9d816a154868bb5887467d6cbbc9aaefd32ec1860cbf337cd0ba92abef#g;
	s#candidate-Gate3-da921x-untag-2a6dcc2a#candidate-Gate3-da921x-fallthrough-7e184dd0#g;
	s#DA921x untagged dispatch#DA921x normal uevent fallthrough#g;
	s#2026-08-01-da921x-uevent-untagged-dispatch#2026-08-01-da921x-uevent-normal-fallthrough#g;
	s#gemini-da921x-untag#gemini-da921x-fallthrough#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=1b2b6c29a8c6891cc91c732472a3c8b9d4f8fce2cc935a18311f0f4d0da5035b' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=3665c0ec7a1d5fde6c5c7bdcbf90b13d73a35c150f2e39b9bfe1f660d8410069' \
