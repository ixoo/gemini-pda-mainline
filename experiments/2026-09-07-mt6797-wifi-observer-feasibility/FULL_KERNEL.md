...
kernel from [55 pinned patches](full-kernel-inputs.json): the previously
...
[Ethernet connection correction](USB_ETHERNET_CONNECT.md), the
...
[HIF resource admission check](HIF_ADMISSION.md).
