#!/usr/bin/env python3
"""Classify the hardware-free CPU8 hotplug-lifecycle KUnit suite."""
...
PROFILE = "a72-hotplug-lifecycle-kunit"
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    require(ktap.count("1..10") == 1, "focused test plan changed")
    ...
    suite_summary = f"# {SUITE}: pass:10 fail:0 skip:0 total:10"
...
def main() -> None:
    ...
    print("experiment=2026-08-27-mainline-a72-hotplug-lifecycle-bridge")
    ...
    print("lifecycle_bridge_symbols=present")
