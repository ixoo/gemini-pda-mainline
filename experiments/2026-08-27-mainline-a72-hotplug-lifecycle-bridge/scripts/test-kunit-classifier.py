#!/usr/bin/env python3
"""Mutation tests for the CPU8 hotplug-lifecycle KUnit classifier."""
...
SPEC = importlib.util.spec_from_file_location("hotplug_lifecycle_classifier",
                                              CLASSIFIER)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
RELEASE = "7.1.3-gemini-a72-lifecycle-kunit"
...
1..10
{cases}
# {MODULE.SUITE}: pass:10 fail:0 skip:0 total:10
...
def main() -> None:
    ...
    mutations = (
        ...
        raw.replace("pass:10 fail:0", "pass:9 fail:1", 1),
        raw.replace("1..10", "1..11", 1),
