#!/usr/bin/env python3
"""Pinned identities for storage-inert Candidate AP."""
...
EXPERIMENT = "2026-07-24-mt6797-dvfsp-i2c6-consumer"
CANDIDATE = "AP"
PROFILE = (
...
BOOT_MEMBER = "gemini-mt6797-dvfsp-i2c6-consumer.boot.img"
DTB_MEMBER = "mt6797-gemini-pda-dvfsp-i2c6-consumer.dtb"
INITRAMFS_MEMBER = "gemini-dvfsp-i2c6-consumer-initramfs.img"
ARTIFACT_PREFIX = "candidate-AP-mt6797-dvfsp-i2c6-consumer-"
...
IMAGE_GZ_SHA256 = "1dca59ec6cf75523387985a73b362709976ae484be3769f2d0a754accf894f2a"
SYSTEM_MAP_SHA256 = "23c0c6a5505a341c6e37ebe5b112f5f315ec971c7a5f17c820ce81501e40b2bc"
CONFIG_SHA256 = "af4e641b24915e64b6cc045b207e8f665c55cd6314d29e37be8784c9d2f513c0"
SOURCE_BUILD_SHA256 = "06f8aedc7b0f058d01dad6fff843a9a7b284e6c70bffbef72f702a0020cc2fae"
RAW_SHA256 = "127e511711bc06a91fcfc3c716aaad2084cc42ffc6452046a582bd53f54b2924"
RAW_SIZE = "7391232"
ARTIFACT_MANIFEST_SHA256 = "dae6d5b891dfccdfc7831cea18fff2b4f43de345333f07e50303619dadd07f7a"
...
def artifact_pin_state() -> str:
    ...
    if all(unresolved):
        return "ready-to-pin"
    if any(unresolved):
        raise ValueError("Candidate AP artifact calibration is only partially pinned")
...
def require_artifact_pins() -> None:
    ...
    for name, value in hashes.items():
        if HEX256.fullmatch(value) is None:
            raise ValueError(f"Candidate AP {name} is unresolved or malformed")
    if not RAW_SIZE.isdecimal() or not 0 < int(RAW_SIZE) <= BOOT2_SIZE:
        raise ValueError("Candidate AP RAW_SIZE is unresolved or malformed")
    if RAW_SHA256 == AO_RAW_SHA256:
        raise ValueError("Candidate AP raw identity equals a predecessor")
