...
REPOSITORY_COMMIT = "eb87d46ae9d58df1ff336751103745d58eed59fe"
PROFILE = "a72-admission-durable-candidate"
RELEASE = "7.1.3-gemini-a72-admission-trace"
PACKAGE_NAME = "linux-7.1.3-gemini-a72-admission-durable-candidate-13dd59d3-a15d3567"
IMAGE_SHA256 = "3468c9ccc8c5e965980d283e4e441ab78ca6531a5a44e989ff4d742285f2f3b3"
IMAGE_GZIP_SHA256 = "05c9f1960ac315baf4d20b37f126a7fc700acfc137f5e977650cf916395c3d3b"
DTB_SHA256 = "1bd6ce2ded2e1186503cb0d9d00107964ec27abc48062b9210e1935d38d60509"
CONFIG_SHA256 = "d59b56cfe259fdc4294a3d51c7dcab66ba4b5270bf4b6ea526763fd4dc534c89"
SYSTEM_MAP_SHA256 = "f9d1242a102c4a0e5544991ab8d9f7bd5263e158f0ec5d07d41368fbbc701585"
BUILD_JSON_SHA256 = "d02a8aa8ac144fb590ac4515a1bce4b67d8286fa1bc857bf5135daa4b59d29c5"
PACKAGE_MANIFEST_SHA256 = "27d550c7c88a49331d325ed1cf8dfba64dd6ed2f8fc3ae83c66f7301ea3a0604"
...
RAW_SHA256 = "ed6fc5294f5677ed1895bf1157649330c91dd1f6051a6677f2d26972915cd185"
PADDED_SHA256 = "60902c7ba7e5cccd781082d6d17e1bcb273d184751ddc9dde6a64b2e2a58b8d1"
RAW_SIZE = 6_934_528
BOOT2_SIZE = 16_777_216
BOOT_NAME = "gemini-a72adm"
BOOT_CMDLINE = "bootopt=64S3,32N2,64N2"
BOOT_FILE = "gemini-mt6797-a72-admission-trace.boot.img"
...
def main() -> None:
    ...
    require(artifact.name == f"candidate-a72-admission-trace-{RAW_SHA256[:8]}",
    ...
    for marker in (
        b"GEMINI_A72_ADMISSION_TRACE_V1 token=GAAT-20260828-A kind=entry slot=2",
        b"GEMINI_A72_ADMISSION_TRACE_V1 token=GAAT-20260828-A kind=zero-source-register slot=3",
        b"GEMINI_A72_ADMISSION_TRACE_V1 token=GAAT-20260828-A kind=zero-derive slot=3",
        b"GEMINI_A72_ADMISSION_TRACE_V1 token=GAAT-20260828-A kind=zero-publish slot=3",
    ):
        require(image.read_bytes().count(marker) == 1,
                f"Image durable trace marker changed: {marker!r}")
    ...
    print("validation=a72-admission-durable-candidate-independent")
