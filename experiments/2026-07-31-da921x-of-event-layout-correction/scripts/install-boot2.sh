...
# corrected real-OF event-layout candidate.
set -euo pipefail
export LC_ALL=C
umask 077
...
perl -0pe '
	...
	s#4afe2d97662e9cde1da0a27e2f4a58e0a05e425d9cd5da69abfa51f4136bcea9#d9370fd47dd4c4e3ae1851ffd639a9b1e623b3f36de54560935323618690def2#g;
	...
	s#ad82cab56687ee3b8cccda7bb8010b6bb82363f23c77153f59d3ac0a73b46275#794465c31e25c31d5884b8ae5be04f5836eb451427fd36113ea64ea938881ed2#g;
	s#candidate-Gate3-da921x-envstate-b6d6b25d#candidate-Gate3-da921x-ofevent-461e90ef#g;
	s#DA921x dual-modalias event-envelope state#DA921x corrected real-OF event layout#g;
	s#2026-07-31-da921x-dual-modalias-envelope-state#2026-07-31-da921x-of-event-layout-correction#g;
	s#gemini-da921x-envstate#gemini-da921x-ofevent#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=1c703eb0f649bb33d7c49b1d3a3bd9e966cdf5f9f2a3920ac789ffb886bff4b7' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=d9370fd47dd4c4e3ae1851ffd639a9b1e623b3f36de54560935323618690def2' \
