...
# Read exact serviceability and clock-entry markers over the initramfs netcat
# shell. This performs no memory, storage, CPU, clock, or power action.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=40b7c663b835bcf4c48f4149f14aa416343e3e322ab78a0aa38448afff9455b4
