...
def main():
    ...
    patch = (HERE / "0001-wifi-mediatek-mt6797-private-hif-core.patch").read_bytes()
    ...
    managed = ROOT / "artifacts/wifi-hif-core"
    ...
    marker = "mt6797-private-hif-host-verification-v1\n"
    ...
    with tempfile.TemporaryDirectory(prefix="verify-", dir=managed) as directory:
        ...
        for name, expected in spec["adapter_files"].items():
        ...
        checked = subprocess.run([
            ...
            str(HERE / "0001-wifi-mediatek-mt6797-private-hif-core.patch")],
            capture_output=True, text=True, timeout=60)
