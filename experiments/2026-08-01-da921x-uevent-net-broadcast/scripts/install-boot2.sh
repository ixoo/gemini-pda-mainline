...
# net-broadcast-wrapper candidate.
set -euo pipefail
export LC_ALL=C
umask 077
...
perl -0pe '
	...
	s#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#0c31f1c73bcd7f61d6b10010e17bd4de3bcc05ab6239130cab5d7fa2d26e139d#g;
	s#__KEEP_OLD_CANDIDATE__#b8113be2e197a8ab06baf863da8679ff585360ef75b8c60359742f8afb862274#g;
	s#__NEW_CANDIDATE__#1b2b6c29a8c6891cc91c732472a3c8b9d4f8fce2cc935a18311f0f4d0da5035b#g;
	s#de71c72f6dab69de7d3a2dee6fe7e98ca16c8e09d4d2811e64ef568eff40a53b#cd5a99d13eab43e695d6e072fb2709eb0303f38aa3b15cac0ae210fe553acae5#g;
	s#candidate-Gate3-da921x-untag-2a6dcc2a#candidate-Gate3-da921x-netwrap-bd0a9268#g;
	s#DA921x untagged dispatch#DA921x net broadcast wrapper#g;
	s#2026-08-01-da921x-uevent-untagged-dispatch#2026-08-01-da921x-uevent-net-broadcast#g;
	s#gemini-da921x-untag#gemini-da921x-netwrap#g;
...
grep -Fq 'EXPECTED_PREDECESSOR_SHA256=0c31f1c73bcd7f61d6b10010e17bd4de3bcc05ab6239130cab5d7fa2d26e139d' \
	"$derived" || die 'derived installer lacks exact predecessor'
grep -Fq 'CANDIDATE_SHA256=1b2b6c29a8c6891cc91c732472a3c8b9d4f8fce2cc935a18311f0f4d0da5035b' \
