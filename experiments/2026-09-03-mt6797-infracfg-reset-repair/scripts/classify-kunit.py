#!/usr/bin/env python3
"""Classify the focused MT6797 infracfg reset KUnit runtime."""
...
PROFILE = "mt6797-infracfg-reset-kunit"
SUITE = "mt6797-infracfg-reset-translation"
EXPECTED_CASES = (
    "mt6797_reset_descriptor_contract",
    "mt6797_reset_thermal_transaction",
    "mt6797_reset_pwrap_transaction",
    "mt6797_reset_unknown_public_id_rejected",
    "mt6797_reset_old_linear_id_rejected",
    "mt6797_reset_internal_bank_overflow_rejected",
)
