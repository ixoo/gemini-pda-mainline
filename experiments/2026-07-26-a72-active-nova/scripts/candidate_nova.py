"""Pinned identity for Candidate Nova."""
...
CANDIDATE = "Nova"
PROFILE = "observability-fbcon-rotation-keyboard-wrrd-manual-reboot-smp8-a72-active-nova"
SERIES = "patches/series-a72-active-nova"
...
BOOT_MEMBER = "gemini-mt6797-a72-active-nova.boot.img"
DTB_MEMBER = "mt6797-gemini-pda-a72-active-nova.dtb"
INITRAMFS_MEMBER = "gemini-a72-active-nova-initramfs.img"
ARTIFACT_PREFIX = "candidate-Nova-a72-active-"
