...
- **State:** complete. The first real compile exposed Linux's `current` macro
  colliding with two local identifiers; the semantic-preserving `observed`
  rename and exact follow-up Buildbox compile passed.
