#!/usr/bin/env python3
"""Exercise repaired READY acceptance and decision-changing rejections."""
...
spec = importlib.util.spec_from_file_location(
    "ready_plan_repair_runtime", SCRIPT_DIR / "validate-ready.py"
)
...
mutations = (
    ("installed_full_sha256=9abdd1c6", "installed_full_sha256=00000000"),
