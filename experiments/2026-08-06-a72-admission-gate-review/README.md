...
the partial source/rollback review of the current 180-entry series recorded
separately, and the complete P32R source slice has a validated dedicated
Buildbox package; H13 same-boot numeric CPUHP identity remains open. The A39
inventory is now complete, but its terminal guards remain an implementation
blocker alongside A37 and A40.
