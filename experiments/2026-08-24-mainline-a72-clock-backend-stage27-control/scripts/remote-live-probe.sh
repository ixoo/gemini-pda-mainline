...
# Bounded read-only live probe for the exact read-free clock-backend candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=4c5276ecf3fe60d7df55fd1fe44235432fcd928d2174704e5928bae7d84056e4
