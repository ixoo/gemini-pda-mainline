...
# Bounded read-only live probe for the exact read-free BigiDVFS candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=0b17da983293f68f227931c964021b43efb1cdd57b4d0cf4db3bd70312f6092a
