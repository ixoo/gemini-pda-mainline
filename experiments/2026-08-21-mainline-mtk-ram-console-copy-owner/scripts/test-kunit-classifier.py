#!/usr/bin/env python3
"""Unit-test the exact retained-console reader KTAP classifier."""
...
def fixture() -> str:
    ...
    return f"""Linux version 7.1.3-gemini-mtk-ram-console-reader-kunit (test)
[    0.1] KTAP version 1
[    0.1] 1..1
...
[    0.1]     1..7
{cases}
[    0.1] # {MODULE.SUITE}: pass:7 fail:0 skip:0 total:7
[    0.1] # Totals: pass:7 fail:0 skip:0 total:7
...
def require_reject(raw: str, label: str) -> None:
    try:
        MODULE.classify_runtime(
            raw, "7.1.3-gemini-mtk-ram-console-reader-kunit", 124)
...
def main() -> None:
    ...
    require_reject(raw.replace("1..7", "1..8", 1), "changed plan")
