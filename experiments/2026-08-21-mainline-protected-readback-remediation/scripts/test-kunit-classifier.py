#!/usr/bin/env python3
"""Prove that the protected-readback classifier fails closed."""
...
SPEC = importlib.util.spec_from_file_location("protected_readback_classifier", SCRIPT)
if SPEC is None or SPEC.loader is None:
    raise SystemExit("cannot load classifier")
CLASSIFIER = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(CLASSIFIER)

RELEASE = "7.1.3-gemini-protected-readback-kunit"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="gemini-protected-readback-") as tmp:
        manifest_path = Path(tmp) / "SHA256SUMS"
    ...
    print("validation=mainline-protected-readback-kunit-classifier")
