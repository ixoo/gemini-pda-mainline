#!/usr/bin/env python3
"""Validate pristine CPU8/CPU9 state for the retained-reader mapping fix."""
...
SOURCE_SHA256 = "4ad80105fd840ea02ca57c3dff1dd9fbe10b81047d06169b3981f4caa130867e"
SCRIPT = Path(__file__).resolve()
SOURCE = SCRIPT.with_name("validate-progress-pretrigger.py")
if hashlib.sha256(SOURCE.read_bytes()).hexdigest() != SOURCE_SHA256:
    raise SystemExit("source CPU9 progress pre-trigger validator changed")

spec = importlib.util.spec_from_file_location("cpu9_progress_pretrigger", SOURCE)
assert spec is not None and spec.loader is not None
source = importlib.util.module_from_spec(spec)
spec.loader.exec_module(source)

OLD_CANDIDATE = source.NEW_CANDIDATE
NEW_CANDIDATE = "c531a9e05ae6f2d51211d73fb487efbaef235cfede195ba135e819bd4f2575c0"
...
def main() -> int:
    ...
    try:
        ...
        reason = "exact-ready-pristine-CPU9-retained-reader-mapping-fix-contract"
