...
SUITES = (
    ...
    (
        ...
        (
            ...
            "cpu9_cpu_on_progress_sequence_test",
            "cpu9_cpu_on_progress_gates_test",
            "cpu9_cpu_on_progress_ordering_test",
        ),
    ),
    (
...
def classify_runtime(raw: str, expected_release: str, qemu_exit: int) -> None:
    ...
    require(plans == ["1..8", "1..34", "1..8", "1..12", "1..10",
                      "1..10", "1..9", "1..9", "1..10"],
...
def main() -> None:
    ...
    print("cpu9_progress_tests=8")
    print("cpu9_dispatch_tests=10")
