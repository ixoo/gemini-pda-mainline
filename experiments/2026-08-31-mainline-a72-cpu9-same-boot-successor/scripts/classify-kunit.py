#!/usr/bin/env python3
"""Classify the hardware-free Gemini CPU9 transition-ledger KUnit suite."""
...
PROFILE = "gemini-cpu9-transition-ledger-kunit"
SUITE = "gemini-cpu9-transition-ledger"
...
def main() -> None:
    ...
    print("qemu_exit=124")
    print("result=pass")
    print("cpu8_terminal_gate=true")
    print("cpu9_retained_zone_count=1")
    print("cpu9_stages=5")
