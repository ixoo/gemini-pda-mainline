#!/usr/bin/env python3
"""Validate pristine CPU8/CPU9 state for the membership-lock repair."""
...
SOURCE_SHA256 = "bf19f8d6343df7aeff659941198986b6cd5deccca595b0600a6e951e60385645"
SCRIPT = Path(__file__).resolve()
SOURCE = SCRIPT.with_name("validate-cpu-on-progress-pretrigger.py")
if hashlib.sha256(SOURCE.read_bytes()).hexdigest() != SOURCE_SHA256:
    raise SystemExit("source CPU_ON progress pre-trigger validator changed")

spec = importlib.util.spec_from_file_location("cpu9_cpu_on_progress_pretrigger", SOURCE)
assert spec is not None and spec.loader is not None
source = importlib.util.module_from_spec(spec)
spec.loader.exec_module(source)

OLD_CANDIDATE = source.NEW_CANDIDATE
NEW_CANDIDATE = "65355ce48e1bbab736a33452160493f6b61915ab09a8713ba0ef2da1262f676c"
...
def main() -> int:
    ...
    try:
        ...
        reason = "exact-ready-pristine-CPU9-membership-lock-repair-contract"
