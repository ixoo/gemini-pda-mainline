...
replacements = (
    ...
    ("d28ae6cdf63ca0923f2101ad7252a9908824697280754a69d9e709b553172d54",
     "587475d18c32cb8132842bac4d570ba76a27bb0f1548a6b8e0d0afc9b57dd7e6", 1),
    ...
    ('trigger_probe="$script_dir/remote-trigger-probe.sh"',
     'trigger_probe="$repo_root/experiments/2026-08-19-mainline-da921x-same-value-write-implementation/scripts/remote-trigger-probe.sh"', 1),
