#!/usr/bin/env python3
"""Mutation tests for the platform/provider KUnit classifier."""
...
SPEC = importlib.util.spec_from_file_location("platform_provider_classifier",
                                              CLASSIFIER)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
RELEASE = "7.1.3-gemini-a72-provider-kunit"
...
1..6
{cases}
# {MODULE.SUITE}: pass:6 fail:0 skip:0 total:6
...
def main() -> None:
    ...
    mutations = (
        ...
        raw.replace("pass:6 fail:0", "pass:5 fail:1", 1),
