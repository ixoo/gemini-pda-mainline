...
# Bounded read-only live probe for the exact platform/provider candidate.
set -eu
export LC_ALL=C
BB=/bin/busybox

readonly INSTALLED_FULL_SHA256=ff902d12b95893872990ebf813f24ca298ca76c4f86d4650f3b696cbdc00d79f
