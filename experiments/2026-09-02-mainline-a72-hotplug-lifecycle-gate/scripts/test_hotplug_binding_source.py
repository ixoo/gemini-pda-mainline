...
MUTATIONS = (
    ...
    (SOURCE, "!READ_ONCE(dev->offline_disabled)",
     "READ_ONCE(dev->offline_disabled)"),
    (SOURCE, "READ_ONCE(dev->offline)", "!READ_ONCE(dev->offline)"),
    (SOURCE, "WRITE_ONCE(dev->offline_disabled, false);",
     "WRITE_ONCE(dev->offline_disabled, true);"),
    (SOURCE, "WRITE_ONCE(dev->offline_disabled, true);\nout_unlock:",
     "out_unlock:"),
