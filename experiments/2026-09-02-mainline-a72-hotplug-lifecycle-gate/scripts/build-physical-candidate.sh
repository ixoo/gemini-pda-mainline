...
[[ "$(fdtget -tbx "$control_dtb" /chosen/gemini-late-cpu-provenance record-identity)" == '4b 19 fb 83 2a 58 7c d c3 89 fe 8f 4c 15 ed ec 4b 2f a4 e 8a e0 c5 d 99 32 12 87 8b 50 88 3d' ]] || die 'runtime provenance identity changed'
...
replacements = (
    ...
    ("0b6c85b3d6d870c22513f64d3b61d0944a3e9729ad26c0297b4d29414d561f41", "9c6b745cc153922cf4624739fed7dfcfdf7799895c8afb7cf2a169b65aa11cb9", 1),
    ...
    ("readonly RAW_SIZE=6934528", "readonly RAW_SIZE=6983680", 1),
