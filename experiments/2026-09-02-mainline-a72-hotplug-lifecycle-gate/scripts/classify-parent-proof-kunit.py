#!/usr/bin/env python3
"""Classify the exact read-only CPU8/CPU9 parent-proof KUnit run."""
...
SUITES = (
    (
        ...
        (
            ...
            "mt6797_a72_initial_parent_proof_test",
    ...
    (
        ...
        (
            ...
            "mt6797_binder_parent_proof_test",
...
class ClassificationError(RuntimeError):
    """Raised when runtime evidence does not prove the exact suite set."""
...
def classify_runtime(raw: str, qemu_exit: int) -> None:
    ...
    require(plans == ["1..3", "1..40", "1..12", "1..10"],
...
def main() -> None:
    ...
    print("phase=exact-parent-proof-kunit-qemu")
    ...
    print(f"runner_sha256={sha256(scripts / 'run-parent-proof-kunit-qemu')}")
    ...
    print("parent_proof_tests=2")
    print("regression_tests=60")
    print("failed=0")
    print("skipped=0")
    ...
    print("watchdog_validation=read-only")
