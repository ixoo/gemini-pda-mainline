#!/usr/bin/env python3
"""Classify the disconnected CPU9 restore-executor KUnit run."""
...
PROFILE = "gemini-a72-restore-executor-kunit"
EXPECTED_RELEASE = "7.1.3-gemini-a72-restore-executor-kunit"
PANIC_PREFIX = "Kernel panic - not syncing: VFS: Unable to mount root fs"
PANIC_END_PREFIX = f"---[ end {PANIC_PREFIX}"
SUITE = "mt6797-a72-restore-executor"
CASES = (
    "restore_executor_success_test",
    "restore_executor_entry_refusal_test",
    ...
    "restore_executor_checkpoint_failure_test",
    "restore_executor_completion_failure_test",
)
...
def main() -> None:
    ...
    print("phase=restore-executor-kunit-qemu")
    ...
    print(f"runner_sha256={sha256(scripts / 'run-restore-executor-kunit-qemu')}")
