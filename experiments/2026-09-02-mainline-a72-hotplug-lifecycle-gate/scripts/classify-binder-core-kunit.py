#!/usr/bin/env python3
"""Classify the disconnected one-task A72 binder-core KUnit run."""
...
PROFILE = "gemini-a72-hotplug-binder-core-kunit"
EXPECTED_RELEASE = "7.1.3-gemini-a72-hotplug-binder-core-kunit"
PANIC_PREFIX = "Kernel panic - not syncing: VFS: Unable to mount root fs"
PANIC_END_PREFIX = f"---[ end {PANIC_PREFIX}"
SUITE = "mt6797-a72-hotplug-binder-core"
CASES = (
...
def main() -> None:
    ...
    print("phase=hotplug-binder-core-kunit-qemu")
    ...
    print(f"runner_sha256={sha256(scripts / 'run-binder-core-kunit-qemu')}")
    ...
    print("restore_add_cpu_calls_success=1")
    print("retries=0")
