#!/usr/bin/env python3
"""Classify the exact hardware-free MT6797 CPU9 executor KUnit proof."""
...
PROFILE = "a72-physical-executor-kunit"
EXPECTED_RELEASE = "7.1.3-gemini-a72-physical-executor-kunit"
SUITE = "mt6797-a72-hotplug-executor"
CASES = (
    "mt6797_hotplug_success",
    "mt6797_hotplug_entry_rejections",
...
def main() -> None:
    ...
    print("phase=hardware-free-physical-executor-kunit-qemu")
    ...
    print(f"runner_sha256={sha256(scripts / 'run-physical-executor-kunit-qemu')}")
    ...
    print("qemu_exit=124")
    print("result=pass")
    print("cpu_off_authorization_budget=1")
    print("affinity_call_budget=1")
    print("post_state_snapshot_budget=1")
    print("cpu8_callback_budget=1")
    print("precommit_failure=rejected-without-physical-authorization")
    print("postcommit_failure=terminal-no-retry")
