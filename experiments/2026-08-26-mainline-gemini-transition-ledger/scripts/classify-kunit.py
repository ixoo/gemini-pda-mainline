#!/usr/bin/env python3
"""Classify the hardware-free Gemini transition-ledger KUnit suite."""
...
PROFILE = "gemini-transition-ledger-kunit"
SUITE = "gemini-transition-ledger"
...
def main() -> None:
    ...
    print("experiment=2026-08-26-mainline-gemini-transition-ledger")
