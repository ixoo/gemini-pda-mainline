...
| FAN49101 | Historical I2C0 `0x70` vendor probe logged manufacturer `0x83`, die `0x06`; the source-derived voltage model conflicts with manufacturer documentation. | Patch 0055 remains a disabled historical draft, not a reusable provider. Its voltage/enable contract and read-only-probe claim are withdrawn. Obtain the FAN49101-specific register model and board rail ownership before replacement or enablement. See the [contract correction](../../experiments/2026-09-08-usb-vbus-ownership/README.md). |
