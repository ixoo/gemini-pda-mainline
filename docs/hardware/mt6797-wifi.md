...
| Vendor PDMA init maps `0x11000080+0x80` independently of the Wi-Fi DT window; WLAN, I2C, UART and BTIF reference the same `INFRA_AP_DMA` clock | Pinned MT6797 source/DT and bounded live binding check; [source-derived and observed](../../experiments/2026-09-07-mt6797-wifi-observer-feasibility/results/shared-resource-boundary.json) | The compared channel starts differ, but a new mainline DMA node or access still requires channel, clock, memory protection and shared-owner validation |
