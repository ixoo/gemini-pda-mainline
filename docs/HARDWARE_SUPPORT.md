...
| Cortex-A72 CPU8–9 | `partial` | `local` | `unknown` | Multiple fresh current-mainline attempts passed pristine single triggers with CPUs `0-9` online and independent CPU8/CPU9 scheduler accounting. The standard MT6797 one-package 4+4+2 topology is live-proven: package siblings `0-9`, cluster lists `0-3`, `4-7`, and `8-9`, cluster-local core IDs, and self-only thread siblings. The complete CPU9-only down/restore transaction passes on repeated fresh boots. Exact candidate `ea2aae41...` closes the integrated observation boundary: stage 18 passed, three stable clock records decoded LL 897 MHz, L 1274 MHz, Big 750 MHz, and CCI 629.5 MHz, the policy-free thermal zone stayed at 53.5--53.7 degrees C, and both affinity-pinned A72 workers advanced independently by 71/73 ticks while all 16 bounded writer/peer-reader hashes matched. Earlier topology/RAM and concurrent-load children independently passed their exact hash, accounting, cleanup, and recovery gates. This establishes bounded dual-A72 execution, correct live topology, peer-visible RAM data, repeated complete CPU9 down/restore, and one exact integrated lifecycle/frequency/thermal/load pass on the named device—not stable/default support or general stress. A distinct boot subsequently reproduced the finite stage-18/topology/frequency/RAM result under the published temperature-rise protocol, but its cross-boot thermal comparison rejected rise and spread; full integrated thermal repeatability remains unproved (see the [cold-cycle result](../experiments/2026-09-04-mt6797-a72-frequency-observation/results/cold-rise-runtime-thermal-rejected.txt)). Repeated cold-load cycles, broader hotplug, cpufreq/OPP, thermal protection, suspend, default integration, and upstream review remain open. See the [integrated frequency/thermal/load pass](../experiments/2026-09-04-mt6797-a72-frequency-observation/results/zero-divider-runtime-pass-20260904.txt), [topology/RAM pass](../experiments/2026-09-02-mainline-mt6797-cpu-map/results/runtime-attempt-2-topology-ram-pass-20260902.txt), [concurrent-load pass](../experiments/2026-09-02-mainline-dual-a72-concurrent-multiline/results/runtime-attempt-2-concurrent-multiline-pass-20260902.txt), and [topology-preserving lifecycle repeat](../experiments/2026-09-02-mainline-a72-hotplug-lifecycle-gate/results/topology-repeat-runtime-attempt-1-success-20260903.txt). |
...
| Thermal management | `partial` | `local` | `none` | The supported path runtime-binds the root-only read-only calibration provider and fails closed before hardware effects when calibration is missing or invalid. The repaired infracfg reset provider and ordered MT6797 thermal/AUXADC transaction pass focused hardware-free tests. On the named unit, the isolated consumer deferred until its provider appeared, then bound one policy-free `soc-thermal` zone and reported three plausible temperatures at 36.1, 36.1, and 35.9 degrees C; changed-ID console evidence retained both probe returns and clean shutdown. The current A72 frequency successor again retained thermal probe-complete/success. A separate exact no-workload candidate now returns three complete per-bank snapshots with valid converted samples, correct aggregation and preserved pristine CPU/frequency accounting; see the [observer-path pass](../experiments/2026-09-04-mt6797-thermal-snapshot/results/no-workload-runtime-pass.txt). A fresh bounded attribution run also completed CPU/RAM/frequency and cleanup checks, but rejected the unchanged thermal comparison; per-slot records identify the largest rise within bank 0/sensor 0, which became the final maximum. See the [attribution result](../experiments/2026-09-04-mt6797-thermal-snapshot/results/attribution-runtime-thermal-rejected.txt). A separate bounded recovery run observed the affected slot decrease after worker completion and cleanup, while retaining the shared-boundary thermal rejection; see the [recovery result](../experiments/2026-09-04-mt6797-thermal-snapshot/results/recovery-runtime-thermal-rejected.txt). Conversion age and the physical cause of the workload-associated rise remain unresolved. This proves bounded read-only temperature observation, not IRQ/watchdog protection, trips, cooling, throttling, PM, suspend, or default-profile support; the standalone AUXADC consumer remains disabled. See the [thermal runtime pass](../experiments/2026-09-04-mt6797-thermal-ledger-live-model-repair/results/runtime-attempt-1-success-20260904.txt), [transaction implementation](../experiments/2026-09-04-mt6797-thermal-transaction/README.md), [calibration gate](../experiments/2026-09-03-mt6797-thermal-fail-closed-calibration/README.md), and [frequency-successor retained result](../experiments/2026-09-04-mt6797-a72-frequency-observation/results/successor-runtime-attempt-1-frequency-before-rejected-20260904.txt). |
