...
| Wi-Fi | `unknown` | `missing` | `required-nonfree` | Vendor connectivity/HIF evidence exists; a matching maintained upstream transport, firmware contract and runtime networking result remain unestablished. See the [connectivity recovery record](../experiments/2026-07-12-connectivity-wmt-recovery/README.md). |
