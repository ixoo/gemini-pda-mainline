...
is the current reproduced-and-written observability gate, adding UART0
...
Candidate L has not been selected or runtime-tested, and the partition result
must not be used to promote boot, console, reset, pstore, or display support.
