...
| Wi-Fi | `unknown` | `missing` | `required-nonfree` | An effect-free mainline CONSYS provider bound its passive WLAN client on the named device with all instrumented effect calls at zero. Shared ownership, a maintained upstream transport, firmware/calibration application and runtime networking remain unestablished. See the [passive runtime record](../experiments/2026-09-06-mt6797-consys-passive-boot/results/runtime-20260906.txt) and [connectivity recovery record](../experiments/2026-07-12-connectivity-wmt-recovery/README.md). |
